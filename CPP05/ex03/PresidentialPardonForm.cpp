...
PresidentialPardonForm::PresidentialPardonForm() : AForm("presidential_pardon", 25, 5)
{
}

PresidentialPardonForm::PresidentialPardonForm(std::string target) : AForm("presidential_pardon", 25, 5), _target(target)
{
}
